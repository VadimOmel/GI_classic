"""
Created on Sat Jan 15 20:07:27 2022

@author: Vadim Omelcenko
"""
import pickle
import numpy as np
...
Frc    = opti_input['Prices']
RHS_cpl  = opti_input['RHS4']  #apart from 'RHS' you can also choose 'RHS1', 'RHS2', 'RHS3', 'RHS4'
T    = len(Frc)
L01  = 0
PowerPl = 'Biogas1'
